...
def apply_discount(price, discount_percentage):
    new_price = price - ((discount_percentage / 100) * price)
    return new_price
...
def largest(num1, num2, num3):
    ...
    all_params = [num1, num2, num3]
    for i in all_params:
        large = i if i > 0 else 0
    return large


print('Exercise 6:', largest(30, 13, 34))
...
def calculate_tip(bill, tip_percent):
    return int((tip_percent / 100) * bill)
